...
// Connect to the WiFi
const char* ssid = "Wi-Fi isn't unavailable";
const char* password = "Berkahdalem100%";
const char* mqtt_server = "riset.revolusi-it.com";
const char* user_mqtt="usm";
const char* pass_mqtt="rahasia234";

// const char* mqtt_server = "riset.revolusi-it.com";
const char* topik = "iot/G.211.20.0106";
...
void reconnect() {
 ...
 // Attempt to connect
 if (client.connect("G.211.20.0106",user_mqtt,pass_mqtt)) {
